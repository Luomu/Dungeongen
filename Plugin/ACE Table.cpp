...
void DefineACES(MicroAceTime* at)
{
	...
	ADDPARAM(PARAM_VALUE, "Width", "Dungeon width. Actual width can vary +-1 accomodate for walls.");
	ADDPARAM(PARAM_VALUE, "Height", "Dungeon height. Actual height can vary +-1 to accomodate for walls.");
	...
	ADDPARAM(PARAM_VALUE, "X1", "X coordinate (column) of the tile 1.");
	ADDPARAM(PARAM_VALUE, "Y1", "Y coordinate (row) of the tile 1.");
